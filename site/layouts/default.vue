				...
				.sidebar-content
					...
					.sidebar-nav(:class="{'showed': openedSidebar && openSidebarName == 'menu'}")
						.sidebar-nav__item-wr(v-for="(group, index) in menu")
							...
							//- 		.sidebar-nav-group__label(:class="{'sidebar-nav-group_open': itsActiveGroup(group, index) }")
							...
							//- 				|{{group._id}}
									...
									.sidebar-nav-group__list(v-for="navItem of group.items")
										router-link.sidebar-nav-item.sidebar-nav-item_sub(:to="navItem.url") {{navItem.label}}
			.content-wr
