			...
			.container
				.header-content
					...
					.header__right
						...
						auth-popover
		main.container.main
			aside.sidebar-wr.sidebar-wr_main
				.sidebar-content
					.sidebar-nav-mob-actions
						.sidebar-nav-mob-action.sidebar-nav-mob-action__burger
							.sidebar-nav-mob-action__chart
							.sidebar-nav-mob-action__chart
							.sidebar-nav-mob-action__chart
						.sidebar-nav-mob-action.sidebar-nav-mob-action__more
							.sidebar-nav-mob-action__chart
							.sidebar-nav-mob-action__chart
							.sidebar-nav-mob-action__chart
					.sidebar-nav
						.sidebar-nav__item-wr(v-for="group in menu")
			...
			aside.sidebar-wr.sidebar-wr_secondary
				.sidebar-content
					| всякие штуки
</template>
...
<style lang="scss">
	...
	@media (max-width: $tablet)
	{
		...
		.sidebar-nav-mob-action__burger
		{
			flex-direction: column;
			.sidebar-nav-mob-action__chart
			{
				border-bottom: 2px solid #0492F2;
				min-width: 14px;
				margin-bottom: 3px;
				&:last-child
				{
